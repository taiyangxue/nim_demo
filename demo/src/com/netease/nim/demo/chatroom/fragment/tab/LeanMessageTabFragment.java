 ...
 */
public class LeanMessageTabFragment extends ChatRoomTabFragment {
    private MyMessageFragment fragment;

    public LeanMessageTabFragment() {
...
//        fragment = (ChatRoomMessageFragment) getActivity().getSupportFragmentManager().findFragmentById(R.id.chat_room_message_fragment);
        fragment = (MyMessageFragment) getActivity().getSupportFragmentManager().findFragmentById(R.id.chat_room_message_fragment);
    }
}
