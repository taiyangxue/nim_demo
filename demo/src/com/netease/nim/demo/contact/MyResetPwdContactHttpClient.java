 ...
 */
public class MyResetPwdContactHttpClient extends AsyncTask<Map, Float, String> {
    private static final String TAG ="MyResetPwdContactHttpClient" ;
    private List<NameValuePair> list;
    private HttpEntity entity;

    public MyResetPwdContactHttpClient(List<NameValuePair> list) {
        this.list=list;
    }
