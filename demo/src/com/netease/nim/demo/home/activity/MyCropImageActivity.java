...
import com.netease.nim.demo.common.imageView.SeniorCropImageView;
...
//        cropImageView.clear();
    ...
    private void initCropImageView() {
        cropImageView = (SeniorCropImageView) findViewById(R.id.cropable_image_view);
        Intent intent = getIntent();
...
//        });
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.ok_btn) {
            ...
            try {
                imageViewBitmap = cropImageView.saveCrop();
...
//                PinkToast.makeText(mActivity, R.string.life_image_crop_topbar_crop_error, Toast.LENGTH_LONG).show();
            ...
            if (returnData) {
                ...
                imageViewBitmap.compress(Bitmap.CompressFormat.PNG, 100, baos);
