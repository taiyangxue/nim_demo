...
import com.netease.nim.demo.chatroom.fragment.StudyRoomFragment;
 ...
 */
public class StudyRoomActivity extends UI {
    ...
    private StudyRoomFragment fragment;
    ...
    public static void start(Context context, String roomId, boolean isCreate) {
        ...
        intent.setClass(context, StudyRoomActivity.class);
...
//        rtmpPullUrl = getIntent().getStringExtra("rtmpPullUrl");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.study_room_activity);
        gson = new Gson();
        parseIntent();
//        creatChatRoom();
        // 注册监听
        ...
        enterRequest.setCallback(new RequestCallback<EnterChatRoomResultData>() {
            ...
            public void onFailed(int code) {
                ...
                if (code == ResponseCode.RES_CHATROOM_BLACKLIST) {
                    Toast.makeText(StudyRoomActivity.this, "你已被拉入黑名单，不能再进入", Toast.LENGTH_SHORT).show();
                } else if (code == ResponseCode.RES_ENONEXIST) {
                    Toast.makeText(StudyRoomActivity.this, "聊天室不存在", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(StudyRoomActivity.this, "enter chat room failed, code=" + code, Toast.LENGTH_SHORT).show();
                }
                finish();
            }
            ...
            public void onException(Throwable exception) {
                onLoginDone();
                Toast.makeText(StudyRoomActivity.this, "enter chat room exception, e=" + exception.getMessage(), Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
        ...
        public void onEvent(ChatRoomStatusChangeData chatRoomStatusChangeData) {
            ...
            if (chatRoomStatusChangeData.status == StatusCode.CONNECTING) {
                ...
                if (hasEnterSuccess) {
                    ...
                    Toast.makeText(StudyRoomActivity.this, "getEnterErrorCode=" + code, Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(StudyRoomActivity.this, R.string.net_broken, Toast.LENGTH_SHORT).show();
            }
    ...
    Observer<ChatRoomKickOutEvent> kickOutObserver = new Observer<ChatRoomKickOutEvent>() {
        ...
        public void onEvent(ChatRoomKickOutEvent chatRoomKickOutEvent) {
            Toast.makeText(StudyRoomActivity.this, "被踢出聊天室，原因:" + chatRoomKickOutEvent.getReason(), Toast.LENGTH_SHORT).show();
            clearChatRoom();
        }
    };

    private void initChatRoomFragment(final String roomName) {
        fragment = (StudyRoomFragment) getSupportFragmentManager().findFragmentById(R.id.chat_rooms_fragment);
        if (fragment != null) {
