...
import com.netease.nim.demo.main.fragment.MyClassRoomsFragment;
import com.netease.nim.demo.main.fragment.SessionListFragment;
import com.netease.nim.demo.main.fragment.TeacherErrorFragment;
import com.netease.nim.demo.main.reminder.ReminderId;

public enum MainTab {
    CHAT_ROOM(0, ReminderId.INVALID, MyClassRoomsFragment.class, R.string.chat_room, R.layout.chat_room_tab),
    HOME_ROOM(1, ReminderId.HOME, TeacherErrorFragment.class, R.string.my_home, R.layout.my_home_tab),
